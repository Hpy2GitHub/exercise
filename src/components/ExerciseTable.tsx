...
import { Eye, Edit2, Search, X, Filter } from 'lucide-react';
      ...
      <div className="mb-12">
        <div className="bg-gray-50 rounded-xl p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            {hasActiveFilters && (
              <button onClick={clearAllFilters} className="text-red-600 hover:text-red-800 font-medium underline">
                Clear All
              </button>
            )}
          </div>
                ...
                {MUSCLE_GROUPS.map(muscle => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => togglePrimaryMuscle(muscle.id)}
                      className="sr-only"
                    />
                    {muscle.name}
                  </label>
